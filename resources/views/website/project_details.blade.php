...
<!-- Start line animation section -->
        ...
        @include('website.partials.breadcrumb', ['title' => __('Project details')])
                    ...
                    <div class="col-lg-8">
                        <div class="project-details-content">
                            <div class="project-thumb">
                                <img src="{{ asset('assets/') }}/img/project/thumbnail-project.jpg" alt="">
                                <div class="tag">
                                    <a href="project-details.html">Software</a>
                                </div>
                            </div>
                                    ...
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div class="work-thumb">
                                                <img src="{{ asset('assets/') }}/img/project/work-thumb-slide.jpg" alt="">
                                                <div class="label">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="work-thumb">
                                                <img src="{{ asset('assets/') }}/img/project/work-thumb-slide-1.jpg" alt="">
                                                <div class="label">
                            ...
                            <div class="check-lunch">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <ul class="check">
                                            <li><i><img src="{{ asset('assets/') }}/img/icons/check.svg" alt=""></i>Aenean vitae pharetra leo. Aliquam pri.</li>
                                            <li><i><img src="{{ asset('assets/') }}/img/icons/check.svg" alt=""></i>In aliquet, quam vitae blandit temporg.</li>
                                            <li><i><img src="{{ asset('assets/') }}/img/icons/check.svg" alt=""></i>Aenean volutpat enim vitae tincidunta.</li>
                                            <li><i><img src="{{ asset('assets/') }}/img/icons/check.svg" alt=""></i>Felis at venenatis porttitor, nunc arcua.</li>
                                            <li><i><img src="{{ asset('assets/') }}/img/icons/check.svg" alt=""></i>Maximus felis quam vitae tortor phase.</li>
                                            <li><i><img src="{{ asset('assets/') }}/img/icons/check.svg" alt=""></i>Nulla vulputate urna quis ex pellentes.</li>
                                        </ul>
                                    </div>
                                    <div class="col-lg-6">
